...
module.exports.run = async (bot,message,args) => {
    ...
    let whereroll = ["Eh?! I'm not a map!", "In the depths of the sea! where you will be if you don't give Hammann food!", "Eh?! I'm not a map!", "In the depths of the sea! where you will be if you don't give Hammann food!"];
    let whatroll = ["I'm not answering a pervert!", "I don't know!", "*snobs*", "I'm not answering a pervert!", "I don't know!", "*snobs*"];
